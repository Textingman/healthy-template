        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-6">
              <button className="px-8 py-4 text-base font-semibold text-white rounded-2xl shadow-xl hover:opacity-90 hover:-translate-y-0.5 transition-all"
                style={{ background: 'linear-gradient(135deg, #16a34a, #059669)' }}>
                Get Started
              </button>
              <button className="px-8 py-4 text-base font-semibold text-gray-700 rounded-2xl glass-button">
